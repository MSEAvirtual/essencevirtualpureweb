...
const App = () => {
  ...
  return (
    <>
      ...
      {window.location.search.includes("bypass_closed_screen") ? (
        <div id="view">
        ...
        <div id="view" className="marketplace-closed">
          <div className="nav-bar">
            <img src="/site-logo.png" className="siteLogo" alt="site-logo" />
          </div>
          <div className="marketplace-closed-copy"></div>
        </div>
      )}
      ...
      <Modal
        show={showModal}
        modalStyle={
          component && component.type.name === "ARModalPopUp" && isMobile
            ? {
                transform: "scale(1)",
              }
            : {}
